...
## Standalone EXE file:
- If you don't want to use Python to run the app, use the Windows Standalone EXE file here:
https://github.com/QuantumPixelator/ConanExilesModManager/releases
